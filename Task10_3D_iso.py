...
resolution=100
opacity=0.3
isomin=0.1 # threshold for 'interesting' points
...
def wavefunction(x,y,z):
    ...
    psi=radial(r)*angular(theta,phi,m)
...
densities=wavefunction(X,Y,Z_values)
...
fig.update_layout(
    title=f"Hydrogenic orbital probability density |ψ|²: n = {n}, l = {l}, m = {m}, Z = {Z} protons",
    scene=dict(
